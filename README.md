...
- 🎯 Идеи в конкретных областях: `/idea sales`, `/idea marketing`, `/idea hr` и
  др.
- 🎤 **Голосовые сообщения** - распознавание русской речи и генерация идей по голосовому запросу (Yandex SpeechKit)
...
- 🎤 **Голосовые сообщения** - Отправьте голосовое сообщение на русском языке для генерации идеи
...
- **[Bitrix24 Integration](docs/BITRIX24_INTEGRATION.md)** 🔗 - Интеграция с
  Битрикс24 CRM
- **[Voice Recognition](docs/VOICE_RECOGNITION.md)** 🎤 - Распознавание голосовых сообщений
