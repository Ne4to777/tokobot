...
export class Logger {
  ...
  debug(message: string, meta?: any): void {
    if (config.environment === "development") {
      console.log(
        formatMessage(LogLevel.DEBUG, `[${this.context}] ${message}`, meta)
      );
    }
  }
  ...
  info(message: string, meta?: any): void {
    console.log(
      formatMessage(LogLevel.INFO, `[${this.context}] ${message}`, meta)
    );
  }

  warn(message: string, meta?: any): void {
    console.warn(
      formatMessage(LogLevel.WARN, `[${this.context}] ${message}`, meta)
    );
  }
