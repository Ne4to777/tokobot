...
export class AIService {
  ...
  private buildPrompt(topic?: string): string {
    let prompt =
      "Генератор AI-бизнеса для стартапов. Команда 2-5 человек, РФ рынок, минимальный стартовый капитал.\n\n" +
      "ФОРМАТ (кратко, по делу):\n" +
      "🎯 ПРОБЛЕМА: боль + цифры\n" +
      "💡 РЕШЕНИЕ: AI-технология (реализуемая за 1-3 месяца)\n" +
      "💰 МОНЕТИЗАЦИЯ: модель + ₽чек\n" +
      "📈 ROI: экономия клиента в ₽ или часах\n\n" +
      "УСЛОВИЯ:\n" +
      "- Российский рынок, не требует зарубежных API\n" +
      "- Старт с минимальными вложениями (до 500к₽)\n" +
      "- Реализуемо начинающей командой\n" +
